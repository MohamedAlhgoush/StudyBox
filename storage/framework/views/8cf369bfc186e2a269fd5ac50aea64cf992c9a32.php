...
<h1 class="display-6" style="color: #165896;">STUDENT PROFILE</h1>
<hr>
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                <div class="card">
                    <h2 class="card-header">Your Uploads</h2>
                    <div class="card-body">
                                ...
                                <ul class="list-inline d-flex text-muted mb-0">
                                  <li class="list-inline-item text-truncate mr-auto card-header" style="width:990px;">
                                    ...
                                    <li class="list-inline-item card-header ">
                                        ...
                                        <a href="/university/<?php echo e(Request::segment(2), false); ?>/view_edit/<?php echo e($upload->id, false); ?>" style="color:#fff">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\studybox\resources\views/users/student/student_profile.blade.php ENDPATH**/ ?>